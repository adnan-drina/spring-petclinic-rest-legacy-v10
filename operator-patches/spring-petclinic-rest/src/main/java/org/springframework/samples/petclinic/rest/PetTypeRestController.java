...
public class PetTypeRestController {
    ...
    public ResponseEntity<PetTypeDto> addPetType(@RequestBody @Valid PetTypeDto petType, @Context UriInfo uriInfo) {
    ...
    public ResponseEntity<PetTypeDto> updatePetType(@PathVariable("petTypeId") int petTypeId, @RequestBody @Valid PetTypeDto petType) {
        BindingErrorsResponse errors = new BindingErrorsResponse();
        HttpHeaders headers = new HttpHeaders();
        try {
            if (petType == null) {
