...
public class PetRestController {
    ...
    public ResponseEntity<PetDto> addPet(@RequestBody @Valid PetDto petDto, @Context UriInfo uriInfo) {
    ...
    public ResponseEntity<PetDto> updatePet(@PathVariable("petId") int petId, @RequestBody @Valid PetDto pet) {
        BindingErrorsResponse errors = new BindingErrorsResponse();
        HttpHeaders headers = new HttpHeaders();
        try {
            if (pet == null) {
