...
public class VisitRestController {
    ...
    public ResponseEntity<VisitDto> addVisit(@RequestBody @Valid VisitDto visitDto, @Context UriInfo uriInfo) {
    ...
    public ResponseEntity<VisitDto> updateVisit(@PathVariable("visitId") int visitId, @RequestBody @Valid VisitDto visitDto) {
        BindingErrorsResponse errors = new BindingErrorsResponse();
        HttpHeaders headers = new HttpHeaders();
        try {
            if (visitDto == null) {
